...
import { Avatar, CopyField, Icon } from '@/shared/ui';
    ...
    <div className="py-2.5 px-4">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="shrink-0 text-xs font-bold py-1.25 px-2.75 rounded-lg border-input border-line bg-transparent text-ink-muted cursor-pointer"
        >
        ...
        {confirmKick ? (
          <>
            <button
              ...
              className="shrink-0 text-xs font-bold py-1.25 px-2.75 rounded-lg border-0 bg-danger text-white cursor-pointer"
            >
              Confirm kick
            </button>
            <button
          ...
          <button
            ...
            disabled={isPendingKick}
            onClick={handleKickClick}
            className="shrink-0 text-xs font-bold py-1.25 px-2.75 rounded-lg border-input border-[oklch(0.78_0.12_25)] bg-transparent text-danger cursor-pointer"
          >
      ...
      {loginLink && (
        <div className="mt-2">
          <CopyField value={loginLink} label="Member login link" />
        </div>
      )}
      {loginLinkError && (
