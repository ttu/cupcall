      ...
      {groups.map((g) => {
        ...
        return (
          <button
            ...
            className={cn(
              'w-[38px] h-[38px] rounded-cup-sm border-0 cursor-pointer font-[family-name:var(--font-display)] text-base font-normal bg-surface-2 text-ink-soft transition-[background] duration-150',
              hasIncomplete
