import type { SpecialBetDef } from './types';
import type { Scoring } from '@cup/engine';

/**
 * Returns the ordered list of special bet definitions from the tournament's scoring config.
 * The order matches functional-spec §6.4.
 */
