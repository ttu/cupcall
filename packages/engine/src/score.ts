...
import { scoreRoundOf16, scoreRoundOf8, scoreTopFour } from './scoring/sets-rankings.js';
...
export function scoreCard(
  ...
  return { groupMatches, groupOrder, bronze, final, roundOf16, roundOf8, topFour, specials, total };
}
