...
const PICKS_FRANK = [
  ...
  { bracketMatchKey: 'r32m84', winner: 'ALG' }, // URU vs ALG → ALG (0pts, actual ESP)
  { bracketMatchKey: 'r32m85', winner: 'BIH' }, // BIH vs HAI → BIH (0pts, actual SUI)
  { bracketMatchKey: 'r32m86', winner: 'CPV' }, // JOR vs CPV → CPV (0pts, actual ARG)
  ...
  { bracketMatchKey: 'r16m95', winner: 'CPV' }, // CPV vs AUS → CPV (0pts)
  ...
  { bracketMatchKey: 'qf100', winner: 'CPV' }, // CPV vs BIH → CPV (0pts)
  { bracketMatchKey: 'sf101', winner: 'CIV' }, // CIV vs POR → CIV (0pts)
  { bracketMatchKey: 'sf102', winner: 'ECU' }, // ECU vs CPV → ECU (0pts)
  { bracketMatchKey: 'final', winner: 'CIV' }, // CIV vs ECU → CIV (0pts, actual ARG)
  { bracketMatchKey: 'bronze', winner: 'POR' }, // POR vs CPV → POR (0pts, actual GER)
] as const;
